...
<main class="product">
    <div class="container-fluid">
        ...
        <!-- start  the product-->
        <section class="row background-blue intro">
            <div class="col-sm-10 col-sm-offset-1">
                <h2>RoundCare is 21st Century Pet Care</h2>


                <p>The RoundCare pet monitor is a must for your 21st Century family. Whether in the other room,
                    driving in your car running errands, or at work, with RoundCare pet monitor you can keep
                    track of all of your pets activities 24/7. Don’t want to spend a fortune on pet daycare or a
    ...
    <section class="row features">
        ...
        <div class="col-sm-10 col-sm-offset-1 feature-block">
            <h4 class=" feature-text hover-instruct">
